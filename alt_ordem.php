...
//$sql_PE = "SELECT id,nome from atendente where termino>=curdate() order by nome";
...
$hor = ($row_AT['hora']!='')?$row_AT['hora']:Date('H:i:s:');
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <th scope="col">
    <h2 class="style5"><span class="style3 style17"><strong>Alterar Ordem de Serviço</strong></span></h2>
	<form name="form_alt_ordem" id="form_alt_ordem" method="post" action="man_ordem.php" onSubmit="return verifica_ordem_servico(document.form_alt_ordem)">
	  <table width="600" border="0" bgcolor="#ABC8E6" class="borda2" align="center">
		...
		<tr>
	      ...
	      <td align="left"><input name="sala" type="text" class="borda2" id="sala" value="<?php echo $sal; ?>" size="40" maxlength="30" <?php echo ($nivel==1)?"":" readonly='True'"; ?>></td>
	    </tr>
	    <tr>
	      <td><div align="right" class="style4">Requisitante:&nbsp;</div></td>
	      <td align="left"><input name="requisitante" type="text" class="borda2" id="requisitante" size="60" maxlength="50" value="<?php echo $req; ?>" <?php echo ($nivel==1)?"":" readonly='True'"; ?>></td>
	    </tr>
	    <tr>
	    ...
	    <tr>
	      ...
	      <td align="left">
		    ...
		    <select name="atendente" class="borda2" id="atendente">
			      <?php if ($ate==0) { ?>
				    <option value="0" selected>-- Selecione um atendente --</option>
 				  <?php } ?>
			      <?php do { ?>
