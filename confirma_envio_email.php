...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" class="FundoPaginaInterna">
...
?>
                      ...
                      <td><span class="style2 style1 Texto"><strong><br/>
	                    ...
	                    <tr> 
	                      <td><span class="style9">A senha foi 
	                        enviada para o email informado.</span></td>
	                    </tr>
<?php
					}
					else
...
?>					
                      ...
                      <td><span class="style5"><span class="style10">Os dados informados 
                        est&atilde;o incorretos. </span><br/>
                        <br/>
                        <span class="style10">Clique em</span> <a href="recuperasenha.php" class="LinkLaranja">voltar</a> 
                        <span class="style10">informe os dados e tente novamente.  </span><br/>
                        <br/>
                        </span></td>
	                    </tr>
<?php
