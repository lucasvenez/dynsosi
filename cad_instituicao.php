...
$sql_AT = "SELECT * from instituicao where id=".$id;
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <th scope="col">
    <h2 class="style5"><span class="style3 style17"><strong>I N S T I T U I Ç Ã O</strong></span><br/></h2>
	<form name="form_instituicao" id="form_instituicao" method="post" action="man_instituicao.php" onSubmit="return verifica(document.form_instituicao)">
	<table width="600" border="0" bgcolor="#ABC8E6" class="borda2" align="center">
      ...
      <tr>
          <td valign="middle"><div align="right" class="style4">Instituição:&nbsp;</div></td>
	...
	<p><a href="cons_instituicao.php" class="style5 style3"><strong>&lt;&lt; Voltar</strong></a></p>
    </th>
  </tr>
</table>
