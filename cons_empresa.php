...
$query_sql = "SELECT id, descricao, telefone FROM empresa ORDER BY descricao ASC";
...
<body>
	...
	<table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr>
			<th scope="col"><h2 class="style5 style3 style8">E M P R E S A S</h2>
				<form action="cad_empresa.php" method="post" name="form_cadastro" id="form_cadadastro">
                   <p><input name="btnCadastrar" type="submit" class="caixa1" id="btnCadastrar" value="Cadastrar Nova Empresa"></p>
                </form>  
				...
				<tr bgcolor="#3879BD">
					...
					<td bgcolor="#3879BD"><div align="center"><span class="style4">Telefone</span></div></td>
      				<td>&nbsp;</td>
				</tr>
    			<form action="man_empresa.php" method="post" name="form_consulta" id="form_consulta">
	    		  <?php $i=0;  ?>
	    		  <?php do { ?>
	    		  <tr bgcolor="<?php echo (($i%2)==0)?'#EEF3F7':'#9FC0E1' ?>">
   		      	      <td align="left" bgcolor="<?php echo (($i%2)==0)?'#EEF3F7':'#9FC0E1' ?>" width="60%">
 					     <span class="style6"><?php echo $row_sql['descricao']; ?></span>
			          </td>
   		      	      <td align="center" bgcolor="<?php echo (($i%2)==0)?'#EEF3F7':'#9FC0E1' ?>">
 					     <span class="style6"><?php echo $row_sql['telefone']; ?></span>		            </td>
   		      	      <td width="135" align="center">
				        <input name="btnAlterar" type="submit" class="caixa1" id="btnAlterar" value="Alterar" onClick="vclick('E',<?php echo $row_sql['id']; ?>)">
					    <input name="btnExcluir" type="submit" class="caixa1" id="btnExcluir" value="Excluir" onClick="vclick('D',<?php echo $row_sql['id']; ?>);return excluir('Deseja excluir a empresa:\n <?php echo $row_sql['descricao']; ?>?')">
			          </td>
    		      </tr>
				  <?php $i++; ?>
