...
<body>
	...
	<table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
	  <tr>
	     ...
	     <form name="form_periodo" action="rel_ordens_servico_baixadas.php" method="post" onsubmit="return verifica_rel_periodo(document.form_periodo)">
		 <h2 class="style5 style3 style8">Relat&oacute;rio de Ordens de Serviço Baixadas</h2>
		...
		<table width="100%" border="1" cellspacing="0" bordercolor="#000000" class="borda2">
		    <tr bgcolor="#3879BD">
			    <td><a href="#" onClick="Enviar('data desc, hora desc')"><div align="center"><span class="style4">Data</span></div></a></td>
			      ...
			      <td colspan="2"><a href="#" onClick="Enviar('data_baixa desc, hora_baixa desc')"><div align="center"><span class="style4">Baixa</span></div></a></td>
    		  ...
    		  <tr bgcolor="#3879BD"><td colspan="11"><span class="style4">&nbsp;</span></td></tr>
			</table>
