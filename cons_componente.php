...
$query_sql = "SELECT id, descricao FROM comp_defeito ORDER BY descricao ASC";
...
<body>
	...
	<table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr>
			<th scope="col"><h2 class="style5 style3 style8">C O M P O N E N T E S</h2>
				<form action="cad_componente.php" method="post" name="form_cadastro" id="form_cadadastro">
                   <p><input name="btnCadastrar" type="submit" class="caixa1" id="btnCadastrar" value="Cadastrar Novo Componente"></p>
                </form>  
    			...
    			<form action="man_componente.php" method="post" name="form_consulta" id="form_consulta">
	    		  <?php $i=0;  ?>
	    		  <?php do { ?>
